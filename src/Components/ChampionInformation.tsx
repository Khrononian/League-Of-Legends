...
import Fighter from '../roleicons/Fighter.png'
import Mage from '../roleicons/Mage'
import Tank from '../roleicons/Tank'
import Marksman from '../roleicons/Marksman'
import Assassin from '../roleicons/Assassin'
import Support from '../roleicons/Support'
...
const ChampionInformation = ({ versions }) => {
    ...
    const roleIcons = [
        {role: 'Fighter', icon: Fighter}, {role: 'Mage', icon: Mage}, {role: 'Tank', icon: Tank},
        {role: 'Marksman', icon: Marksman}, {role: 'Assassin', icon: Assassin}, {role: 'Support', icon: Support}
    ]
    const rolePicture = roleIcons.findIndex(roles => roles.role == singleChampion.tags[0])
                ...
                <div className='champion-header'>
                    ...
                    <div className='champion-header-inner'>
                        ...
                        <div className='champion-stats'>
                            ...
                            <div className='champion-stats-inner'>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="34" height="36" color="currentColor" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
